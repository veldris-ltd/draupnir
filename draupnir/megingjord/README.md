...
`draupnir/megingjord/__init__.py`. Edit the docstring, then run `make module-readmes`.
...
**Owns.** The Matrix tier. Cross-forge ledger anchors, policy and gate distribution, the RBAC source of truth, the plug-in signature trust root.
