...
`draupnir/skidbladnir/__init__.py`. Edit the docstring, then run `make module-readmes`.
...
**Owns.** Format conversion, SBOM generation, model card rendering, lineage attestation, registry publish.
